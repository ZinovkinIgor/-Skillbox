...
Из интереса вы попросили вашего друга показать код его программы и поняли, что сделали это не зря — то, что вы увидели,
...
main_list.extend(additional_list_1)
count_5 = main_list.count(5)
for _ in range(count_5):
    main_list.remove(5)
main_list.extend(additional_list_2)
