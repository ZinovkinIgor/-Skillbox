...
euro = int(input('Введите количество EURO: '))
euro_exchange_usd = 1.25 * euro
usd_exchange_rub = 60.87 * euro_exchange_usd
print('Обмен ', euro, 'euro =', euro_exchange_usd, 'usd, или', usd_exchange_rub, 'рублей.')
